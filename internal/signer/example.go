...
func ExampleHealthCheckerFromIssuerAndSecretData(*omegaissuerapi.IssuerSpec, map[string][]byte) (controllers.HealthChecker, error) {
	return &exampleSigner{}, nil
}

func ExampleSignerFromIssuerAndSecretData(*omegaissuerapi.IssuerSpec, map[string][]byte) (controllers.Signer, error) {
	return &exampleSigner{}, nil
}
...
func (o *exampleSigner) Sign(certTemplate []byte) ([]byte, error) {
