...
// OmegaClusterIssuer is the Schema for the sampleclusterissuers API.
...
func (vi *OmegaClusterIssuer) GetConditions() []metav1.Condition {
...
var _ v1alpha1.Issuer = &OmegaClusterIssuer{}

// +kubebuilder:object:root=true

// OmegaClusterIssuerList contains a list of OmegaClusterIssuer.
...
func init() {
	SchemeBuilder.Register(&OmegaClusterIssuer{}, &OmegaClusterIssuerList{})
}
