...
// OmegaIssuer is the Schema for the omegaissuers API.
...
// IssuerSpec defines the desired state of OmegaIssuer
type IssuerSpec struct {
	...
	// referent is a OmegaClusterIssuer, the reference instead refers to the resource
...
func init() {
	SchemeBuilder.Register(&OmegaIssuer{}, &OmegaIssuerList{})
}
