...
import (
	...
	omegaissuerv1alpha1 "github.com/cert-manager/sample-external-issuer/api/v1alpha1"
...
func init() {
	...
	utilruntime.Must(omegaissuerv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	if err = (&controllers.Issuer{
		HealthCheckerBuilder:     signer.OmegaSignerHealthCheckerFromIssuerAndSecretData,
		SignerBuilder:            signer.OmegaSignerFromIssuerAndSecretData,
